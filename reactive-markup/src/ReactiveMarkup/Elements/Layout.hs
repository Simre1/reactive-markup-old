...
data instance Element FlowLayout merged e = forall elems children.
  merged ~ Merge elems children => FlowLayout [Markup elems children e]
...
data instance Element GridChild merged e = forall elems children. merged ~ (Merge elems children) =>
